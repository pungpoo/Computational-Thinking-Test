...
<body>
  ...
  <div class="container">
	...
	<div class="row align-items-center my-5">
	  ...
	  <!-- /.col-lg-8 -->
	  <div class="col-lg-6">
		<p>7. วศินต้องการแวะไปหยิบของขวัญที่บ้านแล้วนำไปให้อรุณาโดยไม่ผ่านสถานที่อื่นเลย วศินจะต้องเดินทางอย่างไรโดยที่ก่อนเริ่มเดินทาง วศินหันไปทางทิศเหนือ ที่ใช้บล็อคคำสั่งน้อยที่สุด</p>
		<p>
		UNTIL เงื่อนไข DO (XXX) หมายถึงให้ทำตามลำดับ XXX จนกว่า เงื่อนไข จะเป็นจริง<br>
		WHILE เงื่อนไข DO (XXX) หมายถึงให้ทำตามลำดับ XXX ตราบใดที่ เงื่อนไข เป็นจริง</p>
	  ...
	  <xml id="toolbox" style="display: none">
		...
		<block type="direction_moveforward"></block>
		<block type="direction_turnleft"></block>
		<block type="direction_turnright"></block>

		<block type="direction_until_front"></block>
		<block type="direction_until_meet"></block>
		<block type="direction_while_front"></block>
		<block type="direction_while_meet"></block>
