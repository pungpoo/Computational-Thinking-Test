...
<body>
  ...
  <div class="container">
	...
	<div class="row align-items-center my-5">
	  ...
	  <!-- /.col-lg-8 -->
	  <div class="col-lg-6">
		<p>5. อรุณาต้องการไปซื้อของที่ห้างสรรพสินค้าโดยไม่ผ่านสถานที่อื่น อรุณาเริ่มเดินทางโดยหันหน้าเข้าหาสตูดิโอแต่งงาน อรุณาจะต้องเดินทางอย่างไร ที่ใช้บล็อคคำสั่งน้อยที่สุด</p>
		<p>Move Forward = เดินไปข้างหน้า 1 ช่อง, <br>
		Turn Right = หันไปทางขวา (อยู่กับที่), Turn Left  = หันไปทางซ้าย (อยู่กับที่)</p>
