...
<body>
  ...
  <div class="container">
	...
	<div class="row align-items-center my-5">
	  ...
	  <!-- /.col-lg-8 -->
	  <div class="col-lg-6">
		<p>6. วศินต้องการแวะไปหยิบของขวัญที่บ้านแล้วนำไปให้อรุณาโดยไม่ผ่านสถานที่อื่นเลย วศินจะต้องเดินทางอย่างไรโดยที่ก่อนเริ่มเดินทาง วศินหันไปทางทิศเหนือ ที่ใช้บล็อคคำสั่งน้อยที่สุด</p>
