...
<body>
  ...
  <div class="container">
	...
	<div class="row align-items-center my-5">
	  ...
	  <!-- /.col-lg-8 -->
	  <div class="col-lg-6">
		<p>8. บอกให้เพื่อนเดินทางจากบ้านไปสำนักงาน โดยก่อนเริ่มเดินทางหันไปทางซ้าย  ที่ใช้บล็อคคำสั่งน้อยที่สุด</p>
		<p>Go Straight หมายถึง เดินตรงไปเรื่อยๆ ถ้าไม่อยู่เงื่อนไข WHILE หรือ UNTIL ใดๆ จะพยายามเดินไปไม่หยุด
		</p>
	  ...
	  <xml id="toolbox" style="display: none">
		...
		<block type="direction_gostraight"></block>
